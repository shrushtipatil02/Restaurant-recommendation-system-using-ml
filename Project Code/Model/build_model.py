...
# Try to load from Dataset folder first, if not available use the Flask folder CSV
try:
    df = pd.read_csv('../Dataset/archive/zomato.csv', encoding='utf-8')
except:
    print("Dataset not found in ../Dataset/archive/zomato.csv, using restaurant1.csv from Flask folder...")
...
# Dropping columns that are not needed for Content-Based Filtering (only drop if they exist)
